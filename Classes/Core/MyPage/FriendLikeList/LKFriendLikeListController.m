...
#import "LKFriendLikeListController.h"
#import "LKFriendLikeListModel.h"

@implementation LKFriendLikeListController
{
    LKFriendLikeListModel * _model;
}

- (void) initController {
    _model = [[LKFriendLikeListModel alloc] init];
